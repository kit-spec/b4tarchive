...
// Initiates mixpanel at the browser

// Check if mixpanel is already initiated.
var mixpanel = global.mixpanel;
if (!mixpanel) {
    mixpanel = require('mixpanel-browser');
}

// Set the Token based on the running environment
var token = '';
if (window.location.host.indexOf('bill4time.com') !== -1 && window.location.host.indexOf('corp.bill4time.com') === -1) {
    token = 'c18f80af9e1cd47e6e8de016212c02e6'; // production project token
} else {
    token = 'a618934f10a00bde4762441c91a2b9bf'; // development project token - used for localhost/staging/development to test that new events firing
}
try {
    mixpanel.init(token);
} catch (e) {
    throw new Error('mixpanel init error: ', e);
}

global.mixpanel = mixpanel;
}).call(this)}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"mixpanel-browser":1}],3:[function(require,module,exports){
'use strict'
